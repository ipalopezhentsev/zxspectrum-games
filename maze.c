...
/* Coarse-grid BFS from player using walls[][] directly (no adj table).
   Fills vis[] for all 126 maze cells.  Cached until the player moves.
...
/* Lookup cached BFS direction for enemy at expanded-grid (exx,eyy).
